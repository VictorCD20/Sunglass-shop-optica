...
export function PageHero({ eyebrow, title, text, children, media, position = "center 28%", carousel }: { eyebrow: string; title: string; text: string; children?: ReactNode; media?: string; position?: string; carousel?: ReactNode }) {
  return <section className="page-hero">
    <div className="page-hero-media">
      {carousel ? (
        <div className="page-hero-carousel">{carousel}</div>
      ) : (
        <>
