    ...
    if (navActions) {
        ...
        mobileMenu.innerHTML = `
            ...
            <div class="mobile-menu-footer">
                <a href="https://wa.me/529999874504?text=Hola,%20quiero%20informaci%C3%B3n%20de%20Sunglass%20Shop%20%C3%93ptica." target="_blank" class="btn btn-outline-gold" style="display: flex; justify-content: center; align-items: center; gap: 8px; padding: 12px; border-radius: 50px; text-decoration: none; font-weight: 500; color: #fff; border: 2px solid var(--primary-gold);"><i class="fa-brands fa-whatsapp"></i> Agendar Cita</a>
            </div>
        `;
